...
var save1: Array[Array]
var save2: Array[Array]
var save3: Array[Array]
...
func _ready():
	...
	buttons[0].set_text(save1[0][0].charData.charName + ' vs ' + save1[1][0].charData.charName)
	...
	buttons[1].set_text(save2[0][0].charData.charName + ' vs ' + save2[1][0].charData.charName)
	...
	buttons[2].set_text(save3[0][0].charData.charName + ' vs ' + save3[1][0].charData.charName)
